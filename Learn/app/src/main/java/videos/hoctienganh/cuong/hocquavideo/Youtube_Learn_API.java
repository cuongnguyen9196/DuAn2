...
public class Youtube_Learn_API extends YouTubeBaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        playerFragment.initialize(API_KEY, new YouTubePlayer.OnInitializedListener() {
            ...
            public void onInitializationFailure(YouTubePlayer.Provider provider, YouTubeInitializationResult youTubeInitializationResult) {
                try {
                    Toast.makeText(Youtube_Learn_API.this, "Error while initializing YouTube", Toast.LENGTH_SHORT).show();
                    ...
                    handler.postDelayed(new Runnable() {
                        ...
                        public void run() {
                            finish();
                            Intent intent = new Intent(Youtube_Learn_API.this, Error_Hoc_Qua_Youtube.class);
