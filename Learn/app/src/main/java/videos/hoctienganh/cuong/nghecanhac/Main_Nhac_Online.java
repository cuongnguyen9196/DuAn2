        ...
        recyclerView.addOnItemTouchListener(new RecyclerItemClickListener(context, recyclerView,
                new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        intent.putExtra("tenbai", musicList.get(position).getSongName());
                        intent.putExtra("image", musicList.get(position).getLinkImages());
                        intent.putExtra("link", musicList.get(position).getLinkMusic());
                        intent.putExtra("tencasi", musicList.get(position).getCaSiName());
