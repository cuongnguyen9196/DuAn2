...
public class Custom_List_Videos_Adapter extends RecyclerView.Adapter<Custom_List_Videos_Adapter.MyViewHolder> {
    ...
    @Override
    public Custom_List_Videos_Adapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View rootView = layoutInflater.inflate(R.layout.item_youtube_swipe, parent, false);
        return new MyViewHolder(rootView);
    }

    @Override
    public void onBindViewHolder(Custom_List_Videos_Adapter.MyViewHolder holder, int position) {
